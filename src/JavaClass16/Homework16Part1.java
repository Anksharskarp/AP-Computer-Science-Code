...
public class Homework16Part1 extends JFrame {
  ...
  public boolean checkForWin() {
    ...
    if (isSame(0, 4, 8) || isSame(2, 4, 6)) return true;
    else return false;
  }

  public boolean isSame(int a, int b, int c) {
    if (buttons[a].getText().equals(buttons[b].getText()) && buttons[b].getText().equals(buttons[c].getText()) && !buttons[a].getText().equals("")) return true;
    else return false;
  }
